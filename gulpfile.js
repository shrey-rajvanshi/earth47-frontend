...
gulp.task('images', function() {
  return gulp.src('./src/images/**/*')
    .pipe($.changed('./_build/src/images'))
    .pipe($.imagemin({
      optimizationLevel: 3,
      progressive: true,
      interlaced: true
    }))
    .pipe(gulp.dest('./_build/src/images'));
});
...
gulp.task('minify-css', function() {
  gulp.src(['./src/scss/*.scss', '!./src/scss/eath47App.scss'])
...
gulp.task('default', ['browser-sync', 'sass'], function() {
  gulp.watch(['*.html', 'src/templates/*.html', 'src/js/*.js', 'src/*.js'], ['bs-reload']);
